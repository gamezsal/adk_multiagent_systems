...
attractions_planner = Agent(
    ...
    # Tool parameter below this line
...
root_agent = Agent(
    ...
    # Add the sub_agents parameter below this line
...
# Native ADK configuration doesn't require an App wrapper
# The runner will automatically detect the root_agent instance.
